...
INSERT INTO "StaffRole" ("id", "slug", "label", "permissionsJson")
VALUES ($d0$cmseedrole_editor$d0$, $d0$editor$d0$, $d0$Editör$d0$, $d0$["content.pages","content.regions","content.nav","content.sitemap","social.instagram","social.youtube","social.tiktok","crm.leads","crm.appointments","crm.appointments.self","commerce.manage","users.manage"]$d0$)
ON CONFLICT ("slug") DO UPDATE SET
  "label" = EXCLUDED."label",
  "permissionsJson" = EXCLUDED."permissionsJson";
