...
import { APPOINTMENT_CANCEL_LEGACY_PATH, APPOINTMENT_CANCEL_PATH } from "@/lib/site-public-url";
...
export function middleware(req: NextRequest) {
  if (req.nextUrl.pathname === APPOINTMENT_CANCEL_PATH || req.nextUrl.pathname === APPOINTMENT_CANCEL_LEGACY_PATH) {
...
export const config = {
  matcher: ["/admin/:path*", "/rezervasyonbilgi", "/rezervasyoniptal"],
};
